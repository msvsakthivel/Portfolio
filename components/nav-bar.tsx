          ...
          >
            {navLinks.map((link, index) => (
              ...
              >
                <Link
                  href={link.href}
                  className="relative text-sm font-medium text-muted-foreground hover:text-black transition-colors group py-2 "
                >
                  {link.label}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="border-t border-border/40 bg-white backdrop-blur-lg md:hidden"
          >
