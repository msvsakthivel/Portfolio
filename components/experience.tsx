    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          <SectionHeader
            title="My Experience"
            description="Professional journey and achievements in DevOps and Cloud Engineering"
          />
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            {experienceData.map((experience, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute -left-2.5 md:left-1/2 transform md:-translate-x-1/2 -top-2 w-6 h-6 rounded-full border-2 border-violet-400 bg-white z-10">
                  <motion.div
                    className="absolute inset-[3px] rounded-full bg-gradient-to-r from-blue-500 to-violet-500"
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
                    transition={{
                      delay: index * 0.2,
                ...
                >
                  ...
                  >
                    ...
                    {/* Card content */}
                    <div className="relative h-full bg-white/80 p-7 rounded-2xl border border-gray-200 backdrop-blur-md transition-all duration-300 group-hover:border-gray-400 overflow-hidden shadow-sm">
                      {/* Header row */}
                      ...
                      {/* Meta information */}
                      <div className="flex flex-wrap gap-4 mb-5 text-gray-500 text-sm">
                        <motion.div
                      ...
                      >
                        {experience.description.map((point, pointIndex) => (
                          <motion.li
                            ...
                            transition={{
                              delay:
                                index * 0.2 + 0.5 + pointIndex * 0.1,
                            }}
                            whileHover={{ x: 3 }}
                          >
                            <motion.span
                              className="inline-block w-2 h-2 mt-2 mr-3 rounded-full bg-blue-500"
                              initial={{ scale: 0 }}
                              whileInView={{ scale: 1 }}
                              transition={{
                                type: "spring",
